    ...
    <footer className="text-center display-7 fw-bold">
      <div>
        <ul className="p-1" id="contact-info">
          ...
          <li>
            <a
              href="https://github.com/Bjavillo1059?tab=repositories"
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/brandon-javillo-76724b170/"
          ...
          <li>
            <a href="./assets/pdf/Resume.pdf" aria-placeholder="Resume">
              Resume
            </a>
          </li>
        </ul>
